...
description:
    - This module can be used for to manage maintenance mode of datastore.
author:
...
options:
    ...
    datastore_cluster:
      description:
      - Name of datastore cluster from all child datastores to be managed.
      - If C(datastore) or C(cluster_name) are not set, this parameter is required.
    cluster_name:
      description:
      - Name of cluster from all child datastores to be managed.
